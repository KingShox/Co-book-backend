...
public class EventController {
  ...
  @RequestMapping(value = "/createEvent", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
  ...
  @RequestMapping(value = "/viewAllEvent", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.GET)
  ...
  @RequestMapping(value = "/updateEventById", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
  ...
  @RequestMapping(value = "/guestList/{eventId}/{employeeId}", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.GET)

  public ResponseEntity<Object> GuestList(@PathVariable Long eventId, @PathVariable Long employeeId) {
    try {
      Employee employee = employeeService.getEmployeeById(employeeId);
      Event event = eventService.addEmployee(eventId, employee);
